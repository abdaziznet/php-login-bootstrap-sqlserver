            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <img class="img img-responsive rounded-circle mb-3" width="160" src="../../web/img/<?php echo $_SESSION['user']['photo'] ?>" />

                        <h3><?php echo  $_SESSION["user"]["name"] ?></h3>
                        <p><?php echo $_SESSION["user"]["email"] ?></p>

                        <p><a href="../dao/logout.php">Logout</a></p>
                    </div>
                </div>
